...
const App = () => {
  ...
  return (
    <div>
      ...
      <News apiKey={apiKey} setProgress={setProgress}  pageSize={pageSize} country="in" category='business' />
      <News apiKey={apiKey} setProgress={setProgress}  pageSize={pageSize} country="in" category='entertainment' />
      <News apiKey={apiKey} setProgress={setProgress}  pageSize={pageSize} country="in" category='health' />
      <News apiKey={apiKey} setProgress={setProgress}  pageSize={pageSize} country="in" category='science' />
      <News apiKey={apiKey} setProgress={setProgress}  pageSize={pageSize} country="in" category='general' />
      <News apiKey={apiKey} setProgress={setProgress}  pageSize={pageSize} country="in" category='sports' />
      <News apiKey={apiKey} setProgress={setProgress}  pageSize={pageSize} country="in" category='technology' />
      {/* <Routes> */}
